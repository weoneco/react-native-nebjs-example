...
import Nebulas from './app/lib/neb.js';

type Props = {};
export default class App extends Component<Props> {
  render() {
    // to test if crypto is loaded successfully
    var cryptoCheck = crypto.createHash('sha1').update('abc').digest('hex')
    console.log(cryptoCheck); 

    // to test nebulas functions
    var getAccountStateResult = ""; 
    ...
    return (
      <View style={styles.container}>
        <Text>
          Use 'Debug JS Remotely' to view the console logs.
        </Text>
      </View>
    );
  }
